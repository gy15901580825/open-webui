...
OPENAI_API_BASE_URLS = os.environ.get("OPENAI_API_BASE_URLS", "http://127.0.0.1:8088/v1")
OPENAI_API_BASE_URLS = (
    OPENAI_API_BASE_URLS if OPENAI_API_BASE_URLS != "" else OPENAI_API_BASE_URL
)

OPENAI_API_BASE_URLS = [
    url.strip() if url != "" else "http://127.0.0.1:8088/v1"
...
try:
    OPENAI_API_KEY = OPENAI_API_KEYS.value[
        OPENAI_API_BASE_URLS.value.index("http://127.0.0.1:8088/v1")
    ]
except Exception:
    pass
